...
in
{
  # Shared toggle: proprietary NVIDIA (default) vs. the open NVK/nouveau stack.
  # Declared here and read by both this module and modules/system/boot.nix, so
  # the driver stack and its matching kernel params can never drift apart.
  options.my.gpu.useNVK = lib.mkEnableOption
    "the open NVK/nouveau driver stack instead of the proprietary NVIDIA driver";
